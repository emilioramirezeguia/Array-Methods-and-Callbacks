...
function getFinals(data) {
  let finalGames = data.filter(function(dataItem){
    return dataItem["Stage"] === "Final";
  })
  return finalGames;
}
...
function getYears(data, allYears) {
...
function getAverageGoals(data) {
  const averageGoals = data.reduce(function(total, goal, index){
